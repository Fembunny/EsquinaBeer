  ...
  newCartProduct.innerHTML =
    `
      ...
      <td class = "product-input">
        ...
        <button type="button" class="remove-product-button">🗑️</button>
      </td>
    `;
...
function updateTotal() {
  ...
  for (var i = 0; i < cartProducts.length; i++) {
    ...
    totalProduct += productQuantity * 1;
  }
  ...
  document.querySelector(".label span").innerText = "R$" + totalAmount;
  document.querySelector(".label label").innerText = " / " + totalProduct + " iten(s)";
}
